...
class RobotStateUtils(concurrent.futures.ThreadPoolExecutor):
    def __init__(self):
        ...
        self.model_limits_pos_x_val = np.linspace(0, 0.01, 11, dtype='float32')
        self.model_limits_pos_y_val = np.linspace(0, 0.01, 11, dtype='float32')
        self.model_limits_pos_z_val = np.linspace(0, 0.01, 11, dtype='float32')
    ...
    def get_next_state(self, state_val_1, state_val_2, state_val_3, action):
        ...
        next_state_val_1 = (state_val_1  + action[0])
        next_state_val_2 = (state_val_2  + action[1])
        next_state_val_3 = (state_val_3 + action[2])
    ...
    def get_indices(self, model_end_pos_x, model_end_pos_y, model_end_pos_z):
        ...
        index_end_pos_x = (index_end_pos_x * 10) / float(0.01)
        index_end_pos_y = (index_end_pos_y * 10) / float(0.01)
        index_end_pos_z = (index_end_pos_z * 10) / float(0.01)
        index_end_pos_x[index_end_pos_x <= 0] = 0
        index_end_pos_y[index_end_pos_y <= 0] = 0
        index_end_pos_z[index_end_pos_z <= 0] = 0
        index_end_pos_x[index_end_pos_x >= 10] = 10
        index_end_pos_y[index_end_pos_y >= 10] = 10
        index_end_pos_z[index_end_pos_z >= 10] = 10
...
def main(alpha, discount, n_policy_iter):
    ...
    policy, feat, n_f = utils.calculate_optimal_policy_func(alpha, discount, n_policy_iter)
