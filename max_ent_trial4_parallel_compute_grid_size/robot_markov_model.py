...
class RobotMarkovModel:
    def __init__(self):
        ...
        trajectories1 = np.genfromtxt\
            ("/home/vignesh/PycharmProjects/dvrk_automated_suturing/data/trial4_grid11_parallel/max_ent_grid11_data1.csv",
             delimiter=",")
        trajectories2 = np.genfromtxt\
            ("/home/vignesh/PycharmProjects/dvrk_automated_suturing/data/trial4_grid11_parallel/max_ent_grid11_data2.csv",
             delimiter=",")
        trajectories3 = np.genfromtxt\
            ("/home/vignesh/PycharmProjects/dvrk_automated_suturing/data/trial4_grid11_parallel/max_ent_grid11_data3.csv",
             delimiter=",")
