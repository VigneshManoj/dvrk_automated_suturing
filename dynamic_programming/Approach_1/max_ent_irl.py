...
class MaxEntIRL:
    ...
    def max_ent_irl(self, trajectories, discount, n_trajectories, epochs, learning_rate):
        ...
        # For visualization of state and action values
        print "states is ", states
        print "action are ", action
        # Location to store the weights computed
        file_dir = "/home/vvarier/dvrk_automated_suturing/max_ent_trial4_parallel_compute_grid_size/" \
                   "trial4_grid11_parallel/weights_grid11.txt"
        ...
        for i in range(epochs):
            # Saves the weights every 20th iteration
            if i % 20 == 0:
                print "Epoch running is ", i
                print "weights is ", weights
                file_open = open(file_dir, 'a')
