...
class RobotMarkovModel:
    def __init__(self):
        ...
        trajectories1 = np.genfromtxt\
            ("/home/vignesh/PycharmProjects/motion_planning_max_entropy_irl/RL_3d_gridsize_11/"
             "trial4_grid11_parallel/max_ent_grid11_data1.csv", delimiter=",")
    ...
    def generate_trajectories(self):
        ...
        for state_trajectory in self.state_trajectories:
            # It is to reset the list to null
