...
=======
        ...
        self.action_space = {}
>>>>>>> parent of 75e677c... trying to create custom gym environment for ddpg
...
def dqn_model(env_obj, alpha, beta, input_dims, tau, batch_size):

    agent = Agent(alpha=alpha, beta=beta, input_dims=input_dims, tau=tau,
                  env=env_obj, batch_size=batch_size, layer1_size=800, layer2_size=600,
                  n_actions=27, gamma=0.99)
    np.random.seed(0)
    score_history = []
    for i in range(1000):
...
=======
            new_state, reward, done, info = env_obj.step(action)
...
>>>>>>> parent of 75e677c... trying to create custom gym environment for ddpg
    ...
    filename = 'dvrk_suturing-alpha00005-beta0005-800-600-optimized.png'
...
if __name__ == '__main__':
    ...
    dqn_model(env_obj, alpha=0.00005, beta=0.0005, input_dims=[3], tau=0.001, batch_size=64)
