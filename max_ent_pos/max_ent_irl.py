...
class MaxEntIRL:
    ...
    def max_ent_irl(self, trajectory_features_array, complete_features_array, discount,
        ...
        for i in range(epochs):
            ...
            expected_svf = self.find_expected_svf(discount, n_trajectories, n_policy_iter, alpha)
    ...
    def find_expected_svf(self, discount, n_trajectories, n_policy_iter, alpha):
        ...
        policy = robot_state_utils.calculate_optimal_policy_func(alpha, discount, n_policy_iter)
